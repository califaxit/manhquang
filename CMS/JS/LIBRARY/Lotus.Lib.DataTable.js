...
function InitLotusTable(TableId, options)
{
    ...
    htmls = htmls + "                <a class=\"tOptions act btnAdd\" title=\"Options\"><img src=\"../images/icons/options.png\" alt=\"\" style=\"margin-right:3px; margin-bottom: -4px\"><span>Thêm</span></a>";//TODO: loi anh o day
    htmls = htmls +"                <!--###########################################################################################-->";
