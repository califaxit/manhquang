...
var CategoryLevel1BO = {
    ...
    Sel_ByIDLang_ByDisable:function (IDLang, Disable)
    {
        ...
        var ret;
        jQuery.ajax({
            url: "/Action/ProcessFrontendAction.ashx?ActionObject=CategoryLevel1&action=Sel_ByIDLang&IDLang="+IDLang+"&Disable="+Disable+"",
            type: "POST",
            dataType: "json",
            data: "",
            cache:false,
    ...
    //sub menu cua menu top trong view All category1
    Sel_Ext_ByCodeCategoryLevel2_ByIDLang: function (Code, TitleLenght, IntroLenght,IDLang) {
        var ret;
        jQuery.ajax({
            url: "/Action/ProcessFrontendAction.ashx?ActionObject=CategoryLevel1&action=Sel_Ext_ByCodeCategoryLevel2_ByIDLang&CodeCategoryLevel2=" + Code + "&TitleLenght=" + TitleLenght + "&IntroLenght=" + IntroLenght+"&IDLang"+IDLang,
            type: "POST",
            dataType: "json",
            data: "",
            cache:false,
