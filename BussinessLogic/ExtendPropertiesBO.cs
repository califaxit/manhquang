...
{    // code QuyDQ
    public  class ExtendPropertiesBO
    {
        ...
        public List<ExtendProperties> Sel_ByCode_ByIDLang(string Code,int IDLang )
        {
            try
            {
                return aDatabaseDA.ExtendProperties.Where(p => p.Code == Code).Where(p => p.IDLang == IDLang).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("ExtendPropertiesBO.Sel_ByCode: {0}", ex.Message));
        ...
        public List<ExtendProperties> Sel_ByCode_ByIDLang_ByType(string Code, int IDLang, int Type)
        {
            try
            {
                return aDatabaseDA.ExtendProperties.Where(p => p.Code == Code).Where(p => p.IDLang == IDLang).Where(m=>m.Type==Type).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("ExtendPropertiesBO.Sel_ByCode: {0}", ex.Message));
        ...
        public List<ExtendProperties> Sel_ByCode_ByIDLang_ByType_ByStatus(string Code, int IDLang, int Type,int Status)
        {
            try
            {
                return aDatabaseDA.ExtendProperties.Where(p => p.Code == Code).Where(p => p.IDLang == IDLang).Where(m => m.Type == Type).Where(m=>m.Status==Status).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("ExtendPropertiesBO.Sel_ByCode: {0}", ex.Message));
        ...
        public List<ExtendProperties> Sel_ByCode_ByIDLang_ByType_ByStatus_Disable(string Code, int IDLang, int Type, int Status, bool Disable)
        {
            try
            {
                return aDatabaseDA.ExtendProperties.Where(p => p.Code == Code).Where(p => p.IDLang == IDLang).Where(m => m.Type == Type).Where(m=>m.Status==Status).Where(m=>m.Disable==Disable).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("ExtendPropertiesBO.Sel_ByCode: {0}", ex.Message));
