...
namespace BussinessLogic
{
    public class CategoryLevel1BO
    {
        ...
        public List<vw_CategoryLevel1ViewAll> Sel_Ext_ByCodeCategoryLevel2(string CodeCategoryLevel2)
        {
            ...
            {
                throw new Exception(String.Format("CategoryLevel1BO.Sel_Ext_ByCodeCategoryLevel2: {0}", ex.Message));
            }
        }
        ...
        public List<vw_CategoryLevel1ViewAll> Sel_Ext_ByCodeCategoryLevel2_ByIDLang(string CodeCategoryLevel2, int IDLang)
        {
            ...
            {
                throw new Exception(String.Format("CategoryLevel1BO.Sel_Ext_ByCodeCategoryLevel2_ByIDLang: {0}", ex.Message));
            }
        }
        ...
        public List<vw_CategoryLevel1ViewAll> Sel_Ext_ByCodeCategoryLevel2_ByIDLang(string CodeCategoryLevel2, int IDLang, bool Disable)
        {
            ...
            {
                throw new Exception(String.Format("CategoryLevel1BO.Sel_Ext_ByCodeCategoryLevel2_ByIDLang_ByDisable: {0}", ex.Message));
            }
        }
        ...
        // KhoiDT ByType_ByStatus_ByIDLang 09/07/2015
        ...
        public List<CategoryLevel1> Sel_ByIDLang(int IDLang)
        {
            ...
            {
                throw new Exception(String.Format("CategoryLevel1BO.Sel_ByIDLang: {0}", ex.Message));
            }
        }
        ...
        public List<vw_CategoryLevel1ViewAll> Sel_Ext_ByIDLang(int IDLang)
        {
            try
            {
            ...
            {
                throw new Exception(String.Format("CategoryLevel1BO.Sel_Ext_ByIDLang: {0}", ex.Message));
            }
        }
        public List<vw_CategoryLevel1ViewAll> Sel_Ext_ByIDLang(int IDLang, bool Disable)
        {
            try
            {
                return aDatabaseDA.vw_CategoryLevel1ViewAll.Where(p => p.CategoryLevel1_CategoryLevel2_IDLang == IDLang).Where(p => p.CategoryLevel1_Disable == Disable).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("CategoryLevel1BO.Sel_Ext_ByIDLang: {0}", ex.Message));
        ...
        #region UPDATE
        public int Upd(List<CategoryLevel1> aListCategoryLevel1)
        {
            try
            {
                aDatabaseDA.CategoryLevel1.AddOrUpdate(aListCategoryLevel1.ToArray());
                return aDatabaseDA.SaveChanges();
            }
            catch (Exception ex)
            {
        ...
        public int Del_ByCode(string Code)
        {
            try
            {
                List<CategoryLevel1> aTemp = aDatabaseDA.CategoryLevel1.Where(p => p.Code == Code).ToList();
                if (aTemp.Count > 0)
                {
                    aDatabaseDA.CategoryLevel1.RemoveRange(aTemp);
                    return aDatabaseDA.SaveChanges();
                }
                return 0;
            }
            ...
            {
                throw new Exception(String.Format("CategoryLevel1BO.Del_ByCode: {0}", ex.Message));
            }
        }
