...
namespace Bussiness
{
    public class Contents_CategoryLevel1BO
    {
        ...
        public List<Contents_CategoryLevel1> Sel_ByCodeContents(string CodeContent) {
            return this.aDatabaseDA.Contents_CategoryLevel1.Where(p => p.CodeContents == CodeContent).ToList();
        }
