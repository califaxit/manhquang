...
namespace BussinessLogic
{
    public class CategoryLevel2BO
    {
        ...
        public List<vw_CategoryLevel2ViewAll> Sel_Ext(bool Disable)
        {
            try
            {
        ...
        public List<CategoryLevel2> Sel_ByCodeCategoryLevel1(string CodeCategoryLevel1)
        {
            ...
            {
                throw new Exception(String.Format("CategoryLevel1_CategoryLevel2BO.Sel_ByCodeCategoryLevel1: {0}", ex.Message));
            }
        }
        ...
        public List<vw_CategoryLevel2ViewAll> Sel_ByKeyCodeCategoryLevel2_ByIDLang(string Key, int IDLang)
        {
            try
            {
                ...
                // return this.aDatabaseDA.vw_CategoryLevel2ViewAll.Where(p => p.Code == Code).Where(p => p.IDLang == IDLang).ToList();
                ...
                return this.aDatabaseDA.vw_CategoryLevel2ViewAll.Where(p => ListCodeTempt.Contains(p.Code)).Where(p => p.IDLang == IDLang).ToList();
        ...
        public int Upd(List<CategoryLevel2> aListCategoryLevel2)
        {
            try
            {
                aDatabaseDA.CategoryLevel2.AddOrUpdate(aListCategoryLevel2.ToArray());
                return aDatabaseDA.SaveChanges();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("CategoryLevel2.Ins: {0}", ex.Message));
            }
        }
