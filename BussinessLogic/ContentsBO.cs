    ...
    public class ContentsBO
    {
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeContents_ByIDLang(string Key, int IDLang)
        {
            try
            {
                ...
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => ListCodeTempt.Contains(p.Contents_Code)).Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).ToList();
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeContents_ByIDLang(string Key, int IDLang, bool Disable)
        {
            try
            {
                ...
                string ListCodeTempt = String.Join(",", ListCode);
                //return this.aDatabaseDA.vw_CategoryLevel1ViewAll.Where(p => p.CategoryLevel1_Code.Contains(ListCodeTempt)).Where(p => p.CategoryLevel1_CategoryLevel2_IDLang == IDLang).ToList();
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => ListCodeTempt.Contains(p.Contents_Code)).Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).Where(p => p.Contents_Disable == Disable).ToList();
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeContents(string Key)
        {
            try
            {
                ...
                string ListCodeTempt = String.Join(",", ListCode);
                //return this.aDatabaseDA.vw_CategoryLevel1ViewAll.Where(p => p.CategoryLevel1_Code.Contains(ListCodeTempt)).Where(p => p.CategoryLevel1_CategoryLevel2_IDLang == IDLang).ToList();
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => ListCodeTempt.Contains(p.Contents_Code)).ToList();
